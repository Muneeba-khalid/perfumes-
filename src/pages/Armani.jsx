...
import armanibanner4 from '../assets/armanibanner4.jpeg';
...
const ArmaniPage = () => {
  ...
  const armaniProducts = products.filter(p => p.brand === 'Armani');
